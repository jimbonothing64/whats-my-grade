...
<section class="py-3">
	...
	<div class="text-2xl font-bold text-center p-4">
		I want to get
		<input class="outline-none w-16 text-inherit bg-inherit border-b border-dashed text-right" />%
		overall
	</div>
	<div class="flex justify-between pt-3 sticky top-0 bg-white dark:bg-gray-800">
		<h3 class="text-xl align-middle font-bold dark:text-white p-5">Forecasted Grades</h3>
		<button
